...
- Each top-level folder has a `README.md` that indexes its contents. Update it when adding or renaming a file, and update the root `README.md` too — both list the guides.
